...
- **Action:** 
    - Thực hiện viết bài và phân tích dữ liệu.
...
- **Skill:** `web-crafting`
- **Action:** 
    - Thiết kế các thành phần UI/biểu đồ minh họa cho bài viết.
...
- **Action:** 
    ...
    - Đóng GitHub Issue (Close Issue) và chuyển sang cột **Done**.
    - Thực hiện phân phối nội dung lên LinkedIn.
